...
if ( $banner ) :
	...
	<section class="banner">
		<?php if ( ! empty( $desktop_image_url ) ) : ?>
			<img src="<?php echo esc_url( $desktop_image_url ); ?>" alt="<?php echo esc_attr( $alt_text ); ?>"
				class="banner__desktop" />
		<?php endif; ?>
		<?php if ( ! empty( $mobile_image_url ) ) : ?>
			<img src="<?php echo esc_url( $mobile_image_url ); ?>" alt="<?php echo esc_attr( $alt_text ); ?>"
			...
			<div class="tabs banner__shortcode">
				...
				<div class="tabs-stage">
					...
					<div class="tab-item" id="tab-3">
						<?= do_shortcode( '[form_search_du_an]' ) ?>
					</div>
				</div>
			</div>
		</div>
