		...
		?>
																	...
																	<div class="box-select">
																		...
																		<select name="gia" id="" class="gia">
																			...
																			foreach ( $prices_rent as $prices_rent ) {
																				echo '<option value="' . $prices_rent->slug . '">' . $prices_rent->name . '</option>';
																			}
																			?>
																		</select>
																		<select name="huong" id="" class="huong">
	...
	public function taxonomies_and_terms_list_shortcode( $atts ) {
		$atts = shortcode_atts(
			array(
				...
				'taxonomies' => 'gia, dien-tich, huong',
			),
			$atts,
	...
	public function taxonomies_and_terms_list_rent_shortcode( $atts ) {
		$atts = shortcode_atts(
			array(
				...
				'taxonomies' => 'gia-rent, phong-ngu-rent, huong-rent, tang-rent',
			),
			$atts,
			'taxonomies_and_terms_list'
		);
