...
class Shortcode {
	public function __construct() {
		...
		add_shortcode( 'taxonomies_and_terms_list_project', array( $this, 'taxonomies_and_terms_list_project_shortcode' ) );
		add_shortcode( 'display_taxonomies', array( $this, 'display_multiple_taxonomies' ) );
		...
		?>
																								<form action="<?php echo esc_url( home_url( '/' ) ); ?>" method="get" class="search-form" role="search">
																									...
																									<div class="box-select">
																										...
																										<select name="quan" id="city_project" class="quan">
																											<?php
																											echo '<option value="all">Chọn Quận</option>';
																											$cities_rent = get_terms( [ 
																										...
																										<select name="phuong" id="districts_project" class="phuong">
																											<option value="all">Chọn Phường</option>
																										</select>
																										...
																										<select name="trang_thai" id="status_project" class="trang_thai">
																											<?php
...
<span class="checkmark"></span>
	...
	public function taxonomies_and_terms_list_project_shortcode( $atts ) {
		$atts = shortcode_atts(
			array(
				'post_type'  => 'du-an',
				'taxonomies' => 'danh-muc-du-an',
			),
			$atts,
			'taxonomies_and_terms_list'
		);
	...
	function display_multiple_taxonomies() {
		$post_types = [ 
			[ 
				'post_type' => 'nha-dat-mua-ban',
				'taxonomy'  => 'danh-muc-nha-dat',
				'title'     => 'Nhà Đất Mua Bán',
			],
			[ 
				'post_type' => 'nha-dat-cho-thue',
				'taxonomy'  => 'danh-muc-cho-thue',
		...
		foreach ( $post_types as $type ) {
			...
			if ( ! empty( $terms ) && ! is_wp_error( $terms ) ) {
				...
				$output .= '<h2>' . esc_html( $type[ 'title' ] ) . '</h2>';
