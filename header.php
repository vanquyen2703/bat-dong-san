			...
			<div class="container">
				<div class="header__wrapper">
					<div class="header__top__menubar">
						<button type="button" class="navbar-toggler btn pr-0 toggle-menu" aria-label="Toggle navigation" aria-expanded="true"
							...
							<svg xmlns="http://www.w3.org/2000/svg" class="close" width="40" height="40" viewBox="0 0 16 16"><path fill="#222222" d="M15.1 3.1L12.9.9L8 5.9L3.1.9L.9 3.1l5 4.9l-5 4.9l2.2 2.2l4.9-5l4.9 5l2.2-2.2l-5-4.9z"></path></svg>
						</button>
					</div>
